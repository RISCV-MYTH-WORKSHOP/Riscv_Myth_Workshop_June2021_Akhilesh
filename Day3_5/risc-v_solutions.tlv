...
//RISC-V MYTH Workshop Akhilesh Belanke
   |cpu
      @0
         $reset = *reset;
      ...
      @1
         ...
         //Extracting Immediate value from Instruction.
         $imm[31:0] = $is_i_instr ? { {21{$instr[31]}}, $instr[30:20] } :
                      $is_s_instr ? { {21{$instr[31]}}, $instr[30:25], $instr[11:7] } :
                      $is_b_instr ? { {20{$instr[31]}}, $instr[7], $instr[30:25], $instr[11:8], {1{1'b0}} } :
                      $is_u_instr ? { $instr[31:12], $instr[11:8], {12{1'b0}} } :
                      { {12{$instr[31]}}, $instr[19:12], $instr[20], $instr[30:21], {1{1'b0}} } ;
         
         //Extracting Opcode from instruction.
         $opcode[6:0] = $instr[6:0];
         
         //Extracting other fields from the instruction.
         //$funct7,$funct3,$rs1,$rs2,$rd,$opcode.
         //Validity checks of different fields.
