...
\TLV
   ...
   //http://makerchip.com/sandbox/0kRfnh0k2/0P1h0mw#
   ...
   |calc
      @1
         ...
         //Logic for Valid condition (Reset or Valid)
      ...
      ?$valid_chk
         ...
         @2
            ...
            $out[31:0] = $reset ? 0 : (($op[2:0] == 2'b00) ? $sum[31:0] : (($op[2:0] == 2'b01) ? $diff[31:0] : (($op[2:0] == 2'b10) ? $prod[31:0] :(($op[2:0] == 2'b11) ? $quot[31:0] : >>2$mem[31:0]))));
            $mem[31:0] = $reset ? 0 : (($op[2:0] == 3'b101) ?  >>2$out[31:0] : >>2$mem[31:0]);
